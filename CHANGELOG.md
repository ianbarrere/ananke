...
- Update repo_devices and repo_roles to match if "devices" or "roles" is anywhere
  in the file parts. Allows for more flexibility with directory structure. 

## [2.0.0] - 2024-10-29

### Changed

- Removed service capabilities. It was only partially supported and I have
  since concluded that it's not very well-suited for that.
- Added support for more flexible directory structures 

## [1.9.0] - 2024-10-22

### Added

- Added support for nested merge bindings (using . notation)

### Changed

- Set default deploy_tags to [] in dispatch 

## [1.8.0] - 2024-10-17

### Added

- Added support for skipping default interfaces (and some associated refactor) 

## [1.7.0] - 2024-10-07

### Added

- Added regex support for path matching
...
[1.8.0]: https://gitlab.com/doubleverify/techops/sre/dv_sre_lib/-/tags/v1.7.0..v1.8.0
[1.7.0]: https://gitlab.com/doubleverify/techops/sre/dv_sre_lib/-/tags/v1.6.1..v1.7.0
[1.6.1]: https://gitlab.com/doubleverify/techops/sre/dv_sre_lib/-/tags/v1.6.0..v1.6.1
[1.6.0]: https://gitlab.com/doubleverify/techops/sre/dv_sre_lib/-/tags/v1.5.3..v1.6.0
